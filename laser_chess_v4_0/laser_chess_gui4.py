...
IMAGE_DIR = Path(sys.path[0]) / "laser_images1"
...
class MyForm(QtWidgets.QMainWindow):
    ...
    def load_pix(self):
        self.mr_fnames = {
            "ur_mr11": "up_right_mirror1a.png",
            "dr_mr11": "down_right_mirror1a.png",
            "ul_mr11": "up_left_mirror1a.png",
            "dl_mr11": "down_left_mirror1a.png",
            "ur_mr21": "up_right_mirror2a.png",
            "dr_mr21": "down_right_mirror2a.png",
            "ul_mr21": "up_left_mirror2a.png",
            "dl_mr21": "down_left_mirror2a.png",
            "ur_mr12": "up_right_mirror1b.png",
            "dr_mr12": "down_right_mirror1b.png",
            "ul_mr12": "up_left_mirror1b.png",
            "dl_mr12": "down_left_mirror1b.png",
            "ur_mr22": "up_right_mirror2b.png",
            "dr_mr22": "down_right_mirror2b.png",
            "ul_mr22": "up_left_mirror2b.png",
            "dl_mr22": "down_left_mirror2b.png",
            "ur_mr11s": "up_right_mirror1a_s.png",
            "dr_mr11s": "down_right_mirror1a_s.png",
            "ul_mr11s": "up_left_mirror1a_s.png",
            "dl_mr11s": "down_left_mirror1a_s.png",
            "ur_mr21s": "up_right_mirror2a_s.png",
            "dr_mr21s": "down_right_mirror2a_s.png",
            "ul_mr21s": "up_left_mirror2a_s.png",
            "dl_mr21s": "down_left_mirror2a_s.png",
            "ur_mr12s": "up_right_mirror1b_s.png",
            "dr_mr12s": "down_right_mirror1b_s.png",
            "ul_mr12s": "up_left_mirror1b_s.png",
            "dl_mr12s": "down_left_mirror1b_s.png",
            "ur_mr22s": "up_right_mirror2b_s.png",
            "dr_mr22s": "down_right_mirror2b_s.png",
            "ul_mr22s": "up_left_mirror2b_s.png",
            "dl_mr22s": "down_left_mirror2b_s.png",
        }
        self.or_fnames = {
            "la_rt1": "laser_right1.png",
            "la_rt2": "laser_right2.png",
            "blk1": "laser_block1.png",
            "blk1s": "laser_block1_s.png",
            "blk2": "laser_block2.png",
            "blk2s": "laser_block2_s.png",
            "tgt_d1": "target_down1.png",
            "tgt_u1": "target_up1.png",
            "tgt_d2": "target_down2b.png",
            "tgt_u2": "target_up2b.png",
            "board": "laser_board2.png",
        }
        self.bm_fnames = {
            "bm_v1": "beam_green1.png",
            "bm_h1": "beam_green2.png",
            "bm_c1": "beam_green3.png",
            "bm_v2": "beam_red1.png",
            "bm_h2": "beam_red2.png",
            "bm_c2": "beam_red3.png",
            "bm_c21": "beam_red_green1.png",
            "bm_c12": "beam_red_green2.png",
        }
        # for k, v in self.mr_fnames.items():
        #     self.mr_fnames[k] = str(IMAGE_DIR / v)
        # for k, v in self.or_fnames.items():
        #     self.or_fnames[k] = str(IMAGE_DIR / v)
        # for k, v in self.bm_fnames.items():
        #     self.bm_fnames[k] = str(IMAGE_DIR / v)
        self.mr_images = {}
        for keyName, fname in self.mr_fnames.items():
            image1 = QtGui.QPixmap(str(IMAGE_DIR / fname))
            self.mr_images[keyName] = image1
        self.or_images = {}
        for keyName, fname in self.or_fnames.items():
            image2 = QtGui.QPixmap(str(IMAGE_DIR / fname))
            self.or_images[keyName] = image2
        self.bm_images = {}
        for keyName, fname in self.bm_fnames.items():
            image3 = QtGui.QPixmap(str(IMAGE_DIR / fname))
    ...
    def save_game(self):
        filename = str(
            QtWidgets.QFileDialog.getSaveFileName(
                self, "Save Game", self.currentDir, "*.lsr"
            )
        )
        if filename:
    ...
    def load_game(self):
        filename = str(
            QtWidgets.QFileDialog.getOpenFileName(
                self, "Load Saved Game", self.currentDir, "*.lsr"
            )
        )
        if filename:
            self.reset_images()
                    ...
                    if sq1 in self.active_squares2:
                        if sq1 == self.selected_sq1 or sq1 == self.selected_sq2:
                            self.set_piece_image(
                                sq1, piece1, active=True, selected1=True
                            )
                        else:
                            self.set_piece_image(
                                sq1, piece1, active=True, selected1=False
                            )
                    else:
                        if sq1 == self.selected_sq1 or sq1 == self.selected_sq2:
                            self.set_piece_image(
                                sq1, piece1, active=False, selected1=True
                            )
                        else:
                            self.set_piece_image(
                                sq1, piece1, active=False, selected1=False
                            )
    ...
    def track_lasers(self):
        ...
        while i < maxiter and not at_end2:
            ...
            if sq1 in self.game_pieces2:
                piece1 = self.game_pieces2[sq1]
                direct_out, action1 = self.strike_piece(
                    piece1, direct_in, 1, last_sq=last_sq1
                )
                if action1 == "activate":
        ...
        while i < maxiter and not at_end2 and not action1 == "win":
            ...
            if sq1 in self.game_pieces2:
                piece1 = self.game_pieces2[sq1]
                direct_out, action2 = self.strike_piece(
                    piece1, direct_in, 2, last_sq=last_sq2
                )
                if action2 == "activate":
                    self.active_squares2[sq1] = 1
                    at_end1 = False
            ...
            if player_1 == player:
                ...
                try:
                    ...
                    if pcid == "bk" and sq2 in self.game_pieces2:
                        ...
                        pass
                    if sq2 not in self.game_pieces2:
                        if (r2 == 0 or r2 == 5) and (c2 == 0 or c2 == 7):
                            pass
                        elif player == 1 and (
                            (r2 == 5 and c2 == 1) or (r2 == 1 and c2 == 7)
                        ):
                            pass
                        elif player == 2 and (
                            (r2 == 0 and c2 == 1) or (r2 == 4 and c2 == 7)
                        ):
                            pass
                        else:
                            self.game_pieces2[sq2] = piece1
